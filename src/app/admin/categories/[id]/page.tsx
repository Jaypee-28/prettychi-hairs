...
export default function EditCategoryPage() {
  ...
  if (fetching) {
    return <div className="flex justify-center p-20"><Loader2 className="animate-spin text-[#FF4D8D]" size={40} /></div>;
  }
    ...
    <div className="max-w-4xl mx-auto pb-20">
      ...
      <div className="flex items-center justify-between mb-10">
        <div>
          ...
          <p className="text-gray-500 font-semibold mt-2 text-lg">Update your existing category details.</p>
        </div>
      </div>
