...
export function LoginForm() {
  ...
  async function onSubmit(data: LoginInput) {
    ...
    try {
      ...
      if (response?.error) {
        setError(response.error === "CredentialsSignin" ? "Invalid email or password." : "An error occurred during login.");
        return;
      }

      // Success! Redirect to callbackUrl (e.g., /checkout) or home
